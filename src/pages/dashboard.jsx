...
//   return (
//     <div className={`space-y-6 bg-gray-50 min-h-screen transition-all duration-300 ${isOpen ? 'pl-4' : 'pl-2'}`}>
//       <h1 className="text-3xl font-extrabold text-gray-900">Dashboard</h1>

//       {/* Stats Grid */}
//       <div className={`grid ${isOpen ? 'grid-cols-1 sm:grid-cols-3' : 'grid-cols-1 sm:grid-cols-2'} gap-6`}>
//         <div className="flex items-center space-x-4 p-6 bg-[#155dfc] text-white rounded-xl shadow-lg hover:scale-105 transition">
//           <CurrencyDollarIcon className="w-12 h-12" />
//           <div>
//             <p className="text-lg font-semibold">Total Sales</p>
//             <p className="text-2xl font-bold">$12,000</p>
